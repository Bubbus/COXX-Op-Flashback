...
f_radios_settings_acre2_longRange = ["co", "dc", "vc", "sl", "ftl"];
...
f_radios_settings_acre2_lr_groups_blufor = [
    ["GRND COMMAND 1",    ["CO","A-SL","B-SL","C-SL","ENG1","MMG1","HMG1","MAT1","HAT1","MTR1","MSAM1","HSAM1","ST1","DT1"]],
    ["GRND COMMAND 2",    ["Hammer 1","Hammer 2"]],
